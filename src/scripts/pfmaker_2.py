...
class PhasefieldMaker:
  def __init__(self, master):
    ...
    self.flags=['POLORDER','GRIDDIM','PROBLEM']
    ...
    #self.dimension = Entry( entryframe)
    #self.dimension.insert(0, 'dimension')
    #self.dimension.pack( side=RIGHT)
    #self.problem = Entry( entryframe )
    #self.problem.insert(0,'Problem')
