...
:: diffusion( const RangeType& u,
              const JacobianRangeImp& du,
	    //   consst JacobianRangeImp& tension,
	      JacobianRangeType& diff ) const 
{
  ...
  diff[0][0]=0.;
  diff[1][0]=muLoc*dxv;
  diff[2][0]=rhodxphi*gamma_*delta_inv;
	   ...
	   GradientRangeType& diff ) const 
{
  ...
  double tension =delta_*gamma_*rhodxphi*dxphi;
...
//   const double lambdaLoc =mu()*0.5;
  ...
  // const double tau00 = dxu;
//   const double tau01 = 0.5*(dzu+dxw);
//   const double tau10 = tau01;
//   const double tau11 = dzw;
