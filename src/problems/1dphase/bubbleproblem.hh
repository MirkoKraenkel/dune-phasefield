...
class BubbleProblem : public EvolutionProblemInterface<
                  ...
                  
{
  ...
  BubbleProblem() : 
    myName_( "BubbleBalanced Problem" ),
  ...
  double r=sqrt(x*x+2*y*y);


   for(int i=1;i<=dimension;i++)
      res[i]=0;

   double tanx=0.5*tanh((r-0.3)/(smear_*delta))+0.5;
...
template <class GridType>
inline double BubbleProblem<GridType>
...
template <class GridType>
inline void BubbleProblem<GridType>
:: printInitInfo() const
{}
...
template <class GridType>
inline std::string BubbleProblem<GridType>
:: description() const
{
