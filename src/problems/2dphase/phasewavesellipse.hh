...
:: evaluate( const double t, const DomainType& arg, RangeType& res ) const 
{
  ...
  double r=0.2*sqrt(5*x*x+y*y);
  
  //res[0]=0.5*tanh((r-0.03)/factor1)+1.;
  //res[0]=shift*(-1*tanh((r-0.16)/factor1)+1);
  res[0]=shift*(-1*tanh((r-0.1)/factor1)+1);
  res[0]+=c1_; 
  // res[0]=.45;
  ...
  factor1*=smear_;
  // res[3]=phiscale_*0.5*tanh((r-0.16)/factor1)+0.5;
  res[3]=phiscale_*0.5*tanh((r-0.1)/factor1)+0.5;
