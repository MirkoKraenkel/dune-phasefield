 ...
 *                                                   
 * 2d problem                                        
 * PhD thesis Gregor Gassner, pg. 991
...
:: evaluate( const double t, const DomainType& arg, RangeType& res ) const 
{
  ...
  if(arg[0]>0)
    { 
      ...
      res[0]=shift*(tanh((r-0.06)/factor1)+1);
      res[0]+=c1_;  
      ...
      // res[2]=0.5;
      factor1=smear_;
      res[2]=phiscale_*0.5*tanh((r-0.4)/factor1)+0.5;
      res[2]*=res[0];
    }
  else{
    ...
    res[0]=shift*(-1*tanh((r-0.04)/factor1)+1);
    res[0]+=c1_;  
    res[1]=0;
  
    // res[2]=0.5;
    factor1=smear_;
    res[2]=phiscale_*0.5*tanh((r-0.3)/factor1)+0.5;
    res[2]*=res[0];
