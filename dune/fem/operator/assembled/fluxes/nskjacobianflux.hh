...
::numericalFlux( const DomainType& normal,
                ...
                FluxRangeType& gRight) const
  {
      ...
      gLeft[ 0 ][ dimDomain+1]=numVisc_*area*0.5;
      gRight[ 0 ][ dimDomain+1]=-numVisc_*area*0.5;
      //----------------------------------------------------------------
      ...
      for(int ii = 0; ii < dimDomain ; ++ii )
        { 
          //(\rho_j,\mu*,\v_i)
          gLeft[ 1 + ii ][ 0 ]=-0.5*jumpImEx[ dimDomain + 1 ]*normal[ ii ];
          //(\rho*,\mu_j,\v_i)
          gLeft[ 1 + ii ][ dimDomain + 1 ]=-imexFactor_*normal[ ii ]*midEn[ 0 ];
          gRight[ 1 + ii ][ dimDomain + 1 ]=imexFactor_*normal[ ii ]*midEn[ 0 ]; 
