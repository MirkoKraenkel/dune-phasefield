...
void axpyCouplings( Couplings& couplings,
                    ...
                    LocalMatrix& localMatrix)                    
{
  for( auto coupling : couplings.intersectionCouplings())
    { 
     ...
     localMatrix.add( i,j,fluxValue[ local_i ][ local_j ]*phiRow[ i ][local_i]*phiCol[ j ][local_j]*factor);
    }
}
...
class Couplings
{
  typedef std::array< std::pair<int , int >,10*dimRange+dimRange*dimRange+10> ElementCouplingType;
  typedef std::array< std::pair<int , int>,9*dimRange+dimRange*dimRange+3>IntersectionCouplingType;
...
void Couplings< 1 >::makeElementCouplings () 
    {   
      ...
      elementCouplings_[ 18 ] = std::pair<int , int>( 5 , 2);// sigma phiv
      elementCouplings_[ 19 ] = std::pair<int , int>( 5 , 5);// sigma sigma 
    }
...
void Couplings< 2 >::makeElementCouplings () 
    {   
      ...
      elementCouplings_[ 18 ] = std::pair<int , int>( 3 , 5);// phi tau
      elementCouplings_[ 19 ] = std::pair<int , int>( 4 , 0);// mu rho 
      elementCouplings_[ 20 ] = std::pair<int , int>( 4 , 1);// mu u
      elementCouplings_[ 21 ] = std::pair<int , int>( 4 , 2);// mu v
      elementCouplings_[ 22 ] = std::pair<int , int>( 4 , 3);// mu phi
      elementCouplings_[ 23 ] = std::pair<int , int>( 4 , 4);// mu mu
      elementCouplings_[ 24 ] = std::pair<int , int>( 5 , 0);// tau rho 
      elementCouplings_[ 25 ] = std::pair<int , int>( 5 , 3);// tau phi
      elementCouplings_[ 26 ] = std::pair<int , int>( 5 , 5);// tau tau
      elementCouplings_[ 27 ] = std::pair<int , int>( 5 , 6);// tau sigma_x
      elementCouplings_[ 28 ] = std::pair<int , int>( 5 , 7);// tau sigma_y
      elementCouplings_[ 29 ] = std::pair<int , int>( 6 , 5);// sigma_x tau 
      elementCouplings_[ 30 ] = std::pair<int , int>( 6 , 6);// sigma_x sigma_x
      elementCouplings_[ 31 ] = std::pair<int , int>( 7 , 5);// sigma_y tau
      elementCouplings_[ 32 ] = std::pair<int , int>( 7 , 7;// sigma_y sigma_y 
  }
...
void Couplings< 2 >::makeIntersectionCouplings () 
  {
    ...
    intersectionCouplings_[ 6 ] = std::pair<int , int>{ 1 , 5};// v tau
    intersectionCouplings_[ 8 ] = std::pair<int , int>{ 2 , 0};// u rho
    intersectionCouplings_[ 9 ] = std::pair<int , int>{ 2 , 1};// u v
    intersectionCouplings_[ 10 ] = std::pair<int , int>{ 2 , 2};// u u
    intersectionCouplings_[ 11 ] = std::pair<int , int>{ 2 , 3};// u phi
    intersectionCouplings_[ 12 ] = std::pair<int , int>{ 2 , 4};// u mu
    intersectionCouplings_[ 13 ] = std::pair<int , int>{ 2 , 5};// u tau
    intersectionCouplings_[ 14 ] = std::pair<int , int>{ 3 , 1};// phi v
    intersectionCouplings_[ 15 ] = std::pair<int , int>{ 3 , 2};// phi u 
    intersectionCouplings_[ 16 ] = std::pair<int , int>{ 3 , 3};// phi phi
    intersectionCouplings_[ 17 ] = std::pair<int , int>{ 5 , 5};// tau tau
    intersectionCouplings_[ 18 ] = std::pair<int , int>{ 5 , 6};// tau sigma_x
    intersectionCouplings_[ 19 ] = std::pair<int , int>{ 5 , 7};// tau sigma_y
    intersectionCouplings_[ 20 ] = std::pair<int , int>{ 6 , 3};// sigma_x phi
    intersectionCouplings_[ 21 ] = std::pair<int , int>{ 7 , 3};// sigma_y phi 
    intersectionCouplings_[ 22 ] = std::pair<int , int>{ 6 , 6};// sigma_x sigma_x
    intersectionCouplings_[ 23 ] = std::pair<int , int>{ 7 , 7};// sigma_y sigma_y
  }
