#ifndef DUNE_PHASEFIELD_LDGFLUXWELLBAL_HH
#define DUNE_PHASEFIELD_LDGFLUXWELLBAL_HH
...
namespace Dune {
  ...
  public:
    ...
    double gradientNumericalFlux(const Intersection& intersection,
    ...
    template<class DiscreteModelImp,
						 ...
						 class QuadratureImp>
    inline double allenCahnNumericalFlux(const Intersection& intersection,
																				 ...
																				 AcRangeImp& gLeft,
																				 AcRangeImp& gRight,
																				 AcJacobianRangeImp& gDiffLeft, // not used here (only for primal passes)
																				 AcJacobianRangeImp& gDiffRight ) const
    { 
      ...
      return allenCahnNumericalFlux(intersection, discreteModel, time,
    ...
    inline double allenCahnNumericalFlux(const Intersection& intersection,
																				 ...
																				 const RangeType& uLeft,
																				 const RangeType& uRight,
																				 const JacobianRangeImp& sigmaLeft,
																				 const JacobianRangeImp& sigmaRight,
																				 AcRangeImp& gLeft,
																				 AcRangeImp& gRight,
																				 AcJacobianRangeImp& gDiffLeft, // not used here (only for primal passes)
																				 AcJacobianRangeImp& gDiffRight ) const
		{ 
			...
			if( useExterior ) 
				{
          model_.allenCahnDiffusion(inside, time, 
                                    faceQuadInner.point( quadPoint ),
																		sigmaLeft, diffmatrix);
        }
			else 
				{
					model_.allenCahnDiffusion(outside, time, 
                                    faceQuadOuter.point( quadPoint ),
																		sigmaRight, diffmatrix);
				}
