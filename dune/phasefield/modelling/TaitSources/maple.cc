...
inline double a ( double rho ,double phi ) const
{
  ...
  double t6;
  {
    ...
    t6 = t5*t4;
    t11 = t1*phi;
    t18 = sqrt(0.882E12*t3*t6-0.2205E13*t2*t6+0.147E13*t11*t6+1753186565.0
-0.1051911939E11*t3+0.2629779848E11*t2-0.1753186565E11*t11);
    return(0.1E-4*t18);
  }
}
...
double a(double rho,double phi)
{
  ...
  double t6;
  {
    ...
    t6 = t5*phi;
    t11 = t4*phi;
    t18 = sqrt(0.882E12*t3*t6-0.2205E13*t3*t5+0.147E13*t3*t11+1753186565.0
-0.1051911939E11*t6+0.2629779848E11*t5-0.1753186565E11*t11);
    return(0.1E-4*t18);
  }
}
