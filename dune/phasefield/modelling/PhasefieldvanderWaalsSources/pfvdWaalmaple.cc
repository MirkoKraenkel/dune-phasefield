...
inline double drhoreactionSource ( double rho ,double phi ,double old ) const
{
  ...
  double t5;
  {
    ...
    t14 = t11*t11;
    t18 = log(rho);
    t20 = -0.1351941256E-1/t11+0.1351941256E-1*rho/t14-0.9990832252E-2*t18
-0.9057494716E-1;
    t25 = -0.1425550545*rho+0.7074554549E-1*t18+0.1735845909;
    t30 = 360.0*t4-0.18E3*phi-0.18E3*old+60.0;
    return(t10*t20-t10*t25+(t30*t20-t30*t25)*(phi-old)/24.0);
  }
}
...
inline double a ( double rho ,double phi ) const
{
  ...
  double t9;
  {
    ...
    t9 = t3*rho;
    t22 = t2*phi;
    t39 = -0.1069162909E12*t2*t4+0.1773958455E11*rho-0.2542007706E12*t8*t9
-0.2059015064E12*t8*rho+0.3349371484E12*t8*t3+0.3813011559E12*t2*t9+
0.3088522596E12*t2*rho-0.5024057225E12*t2*t3-0.1525204624E12*t22*t9
-0.1235409039E12*t22*rho+0.200962289E12*t22*t3-0.605522833E11*t2+
0.4276651635E11*t22*t4+0.7127752725E11*t8*t4+0.2492053545E11*t9-7127752725.0*t4
-0.3199509E11*t3-3537277274.0+0.4036818887E11*t8+0.2422091332E11*t22;
    t40 = rho-1.0;
    t41 = t40*t40;
