#ifndef PHYSICSWB2_INLINE1D_HH
#define PHYSICSWB2_INLINE1D_HH
namespace Dune{
//================================================
//
//for dim=1
...
public:
  ...
  ::maxSpeed ( const DomainType& n, const RangeType& u) const
  {
    ...
    double c=thermoDynamics_.a( u[0] , u[phaseId] )*n.two_norm2();
